...
class TaskCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_comment" do
    assert_difference('TaskComment.count') do
      post task_comments_url, params: { task_comment: { comment: @task_comment.comment, user_id: @task_comment.user_id } }
    end
  ...
  test "should update task_comment" do
    patch task_comment_url(@task_comment), params: { task_comment: { comment: @task_comment.comment, user_id: @task_comment.user_id } }
