...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { coment_text: @training.coment_text, t_date: @training.t_date, time: @training.time, type_of_training_id: @training.type_of_training_id } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { coment_text: @training.coment_text, t_date: @training.t_date, time: @training.time, type_of_training_id: @training.type_of_training_id } }
