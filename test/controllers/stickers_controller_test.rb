...
class StickersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sticker" do
    assert_difference('Sticker.count') do
      post stickers_url, params: { sticker: { level_id: @sticker.level_id, name: @sticker.name } }
    end
  ...
  test "should update sticker" do
    patch sticker_url(@sticker), params: { sticker: { level_id: @sticker.level_id, name: @sticker.name } }
