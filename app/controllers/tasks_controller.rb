  ...
  def create
    ...
    respond_to do |format|
      if @task.save
        ...
        format.html { redirect_to @task.player, success: 'Task was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @task.update(task_params)
        ...
        format.html { redirect_to session.delete(:return_to) , success: 'Task was successfully updated.' }
